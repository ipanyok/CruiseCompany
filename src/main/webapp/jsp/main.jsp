...
<div class="w3-top w3-hide-small">
    <div class="w3-bar w3-xlarge w3-black w3-opacity w3-hover-opacity-off" id="myNavbar">
        <label>
            ...
            <a href="/cruisecompany?command=bucketButton&bucketBtn=bucket"
               class="w3-bar-item w3-button">${bucketMainLoc}</a>
            <a href="/cruisecompany?command=orderButton&orderBtn=order"
               class="w3-bar-item w3-button">${orderMainLoc}</a>
